...
export function Header() {
  ...
  return (
    <>
      ...
      <header
        className={`sticky top-0 z-40 w-full bg-background/95 backdrop-blur-xl transition-shadow duration-300 ${scrolled ? "shadow-[0_4px_20px_-10px_rgba(0,0,0,0.18)] border-b border-border" : "border-b border-transparent"}`}
      >
